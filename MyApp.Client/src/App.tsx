        ...
        <div
            ...
            <div className="flex gap-4 mb-8">
                <a href="https://servicestack.net" target="_blank" rel="noreferrer">
                    <svg className="h-48 p-6 transition-all duration-300 hover:drop-shadow-[0_0_2em_#646cffaa]"
                ...
                <a href="https://vite.dev" target="_blank" rel="noreferrer">
                    <img
                        src={viteLogo}
                        className="h-48 p-6 transition-all duration-300 hover:drop-shadow-[0_0_2em_#646cffaa]"
                        alt="Vite logo"
                    />
                </a>
                <a href="https://react.dev" target="_blank" rel="noreferrer">
                    <img
                        src={reactLogo}
                        className="h-48 p-6 transition-all duration-300 hover:drop-shadow-[0_0_2em_#61dafbaa] logo-react"
                        alt="React logo"
                    />
                </a>
            </div>
            <h1 className="text-7xl font-bold mb-8">Vite + React + Tailwind</h1>
            <div className="py-4">
